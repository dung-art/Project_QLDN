package com.WebOfNVD.User.Entity.CustomUser;
...
import com.WebOfNVD.Common.Enum.GroupCustomUserEnum;
...
@JGlobalMap(excluded = { "MAXSIZE_CODE", "MINSIZE_CODE", "MINSIZE", "MAXSIZE", "isDelete", "amountSpent",
		...
		"MINSIZE_DESCRIPTION", "MAXSIZE_DESCRIPTION", "MINSIZE_ADDRESS", "MAXSIZE_ADDRESS" })
@Getter
@Setter
@Entity(name = "CustomUsers")
@Table(name = "QLBH_custom_users")
@NoArgsConstructor
public class CustomUser extends EntityBase implements Serializable {
	/**
	 * 
	 */
